#!/usr/bin/env python3
"""
Test script for Inspire RH56 Hand Position Controller
...
class HandPositionTest(Node):
    ...
    def test_partial_close(self):
        ...
        positions = [0.6, 0.3, 0.7, 0.7, 0.7, 0.7]
        self.send_hand_command(positions)
